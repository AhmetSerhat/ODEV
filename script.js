...
let xioamiUrunleri=["REDMİ","450","POCO","1000","Mİ BAND","20"];
...
function urunleriGetir(){
    ...
    if(document.getElementById("kategoriXioami").checked)
    {
        for(i=0;i<xiaomiUrunleri.length;i=i+2)
        {
            olustur();
            urunSecenek.value=xioamiUrunleri[i+1];
            urunAciklama.innerHTML=xioamiUrunleri[i]; 
        }
    }
